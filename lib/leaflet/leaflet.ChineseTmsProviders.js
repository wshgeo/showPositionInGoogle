...
L.TileLayer.ChinaProvider.providers = {
    ...
    Google: {
        Normal: {
            Map: "http://www.google.cn/maps/vt?lyrs=y&gl=cn&x={x}&y={y}&z={z}"
        },
        Satellite: {
            // Map: "http://www.google.cn/maps/vt?lyrs=s@189&gl=cn&x={x}&y={y}&z={z}",
            Map: "https://mt3.google.cn/maps/vt?lyrs=s@189&gl=cn&x={x}&y={y}&z={z}",
            Annotion: "http://www.google.cn/maps/vt?lyrs=y@189&gl=cn&x={x}&y={y}&z={z}"
        },
        HunHeSatellite: {
            // Map: "http://www.google.cn/maps/vt?lyrs=s@189&gl=cn&x={x}&y={y}&z={z}",
            Map: "https://mt3.google.cn/maps/vt?lyrs=y&gl=cn&x={x}&y={y}&z={z}",
            Annotion: "http://www.google.cn/maps/vt?lyrs=y@189&gl=cn&x={x}&y={y}&z={z}"
        },
    ...
    myTiles: {
        Normal: {
            Map: 'http://localhost:9000/image/b89fe670d2d711ea9f595150e4332727/{z}/{x}/{y}'
        },
        Satellite: {
            Map: 'http://localhost:9000/image/b89fe670d2d711ea9f595150e4332727/{z}/{x}/{y}'
        },
